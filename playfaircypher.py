...
ALPHABET_CZECH = "ABCDEFGHIKLMNOPQRSTUVWXYZ"
ALPHABET_ENGLISH = "ABCDEFGHIKLMNOPQRSTUVWXYZ"
PADDING_CHARS = ["X", "Q", "W"]
...
def decrypt(ciphertext: str, key: str, alphabet: str) -> Tuple[str, List[List[str]]]:
